declare module "@google/maps" {
  ...
  /**
   * Payload of a Directions response
   */
  interface DirectionsResponsePayload {
  ...
  export class GoogleMapsClient {
    ...
    public directions(request: google.maps.DirectionsRequest, callback: MapApiResponseHandler<DirectionsResponsePayload>): void;
  }
